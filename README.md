...
<modules>
  <module version="1.0.0">sk.maxapp.tiscreenrecordingdetector</module>
</modules>
...
```js
import MyModule from 'sk.maxapp.tiscreenrecordingdetector';
MyModule.foo();
```
...
```js
var MyModule = require('sk.maxapp.tiscreenrecordingdetector');
MyModule.foo();
```
